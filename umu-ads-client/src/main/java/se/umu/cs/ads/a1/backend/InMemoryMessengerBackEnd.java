        ...
        implements Messenger
{
    ...
    //----------------------------------------------------------
    //----------------------------------------------------------
    public void printMessageKeyMap (String caption)
    {
        MessageId[] messages = messageMap.keySet().toArray(new MessageId[messageMap.size()]);
    ...
    //----------------------------------------------------------
    public void printMessages (String caption)
    {
        Message[] messages = messageMap.values().toArray(new Message[messageMap.size()]);
        Arrays.sort(messages);
